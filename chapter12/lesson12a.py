...
model_r = init_chat_model(
    "gemini-2.0-flash", model_provider="google_genai", temperature=0
)
retrieval_grader = retrieval_prompt | model_r.with_structured_output(GradeDocuments)
...
model_l = init_chat_model(
    "gemini-2.0-flash", model_provider="google_genai", temperature=0
)
hallucination_grader = hallucination_prompt | model_l.with_structured_output(
    GradeHallucinations
)
...
model_g = init_chat_model(
    "gemini-2.0-flash", model_provider="google_genai", temperature=0
)
answer_grader = answer_prompt | model_g.with_structured_output(GradeAnswer)
...
def transform_query(state):
    ...
    question_rewriter = transform_prompt | model_q | StrOutputParser()
